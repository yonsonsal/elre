					...
					<Rule>
					   <Title>Afe</Title>
						<Filter>
						  <And>
								<PropertyIsEqualTo>
									<PropertyName>motivo_remocion</PropertyName>
									<Literal>COLOCACION DE COLUMNAS</Literal>
								</PropertyIsEqualTo>		
					   ...
					   <Title>Afe</Title>
						<Filter>
						  <And>
								<PropertyIsEqualTo>
									<PropertyName>motivo_remocion</PropertyName>
									<Literal>CONEXION DOMICILIARIA</Literal>
								</PropertyIsEqualTo>		
					   ...
					   <Title>Afe</Title>
						<Filter>
						  <And>
								<PropertyIsEqualTo>
									<PropertyName>motivo_remocion</PropertyName>
									<Literal>CABEZAL DE TUNELERAS</Literal>
								</PropertyIsEqualTo>		
