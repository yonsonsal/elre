...
alfresco_url_crear_nodo = "https://imnube.imm.gub.uy/alfresco/api/-default-/public/alfresco/versions/1/nodes/cca24b6e-c7c3-4b77-bd17-72645a1f329a/children"
alfresco_url_shared_link = "https://imnube.imm.gub.uy/alfresco/api/-default-/public/alfresco/versions/1/shared-links"

# Usuario y password para subir a alfresco (los dejo vacíos pero para correr esto hay que cargarlos)
alfresco_username = ""
alfresco_password = ""

# Directorio local
directorio_local = "./Archivos/Ultimo"
...
def subir_archivo_a_alfresco(archivo_local, nombre_archivo):   
	...
	# Cabeceras para la solicitud POST
        ...
        if response_link.status_code == 409:
            ...
            actualizar_link_tabla_proyectos("https://imnube.imm.gub.uy/share/s/"+shared_id,nombre_archivo)            
        else:            
